...
const char APPMENU[] PROGMEM = {
  "<a href=\"status\">Status</a><br>"
  "{appmenu}"};

const char STATUSMENU[] PROGMEM = {
  "<a href=\"on\">Ein</a><br>"
  "<a href=\"off\">Aus</a><br>"
   };
...
const char RADIO_LED_START[] PROGMEM = {
    "<form>"
...
const char RADIO_LED_END[] PROGMEM = {
    "<br><br>"
    "<input type=\"submit\" value=\"senden\">"
    "</form>"
  };
